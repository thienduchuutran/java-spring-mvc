            ...
            <div class="container-fluid py-5 mt-5">
                <div class="container py-5">
                    <div class="row g-4 mb-5">
                        ...
                        <div class="row g-4">
                          <div class="col-lg-6">
                            <div class="border rounded">
                              <a href="#"><img src="/images/product/${product.image}" class="img-fluid rounded" alt=""></a>
                            </div>
                          </div>
                  
                          <div class="col-lg-6">
                            <h4 class="fw-bold mb-1">${product.name}</h4>
                            <p class="mb-2">${product.factory}</p>
                            <h5 class="fw-bold mb-3">$${product.price}0</h5>
                      ...
                      <!-- RIGHT: sidebar (true sibling of left column) -->
